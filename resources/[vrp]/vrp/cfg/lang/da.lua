...
local lang = {
  common = {
    welcome = "<center>Velkommen til <b style='color: #72AEE5'>DIT_SERVER_NAVN</b>.<br>Tryk på <b style='color: #4E9350'>F9</b> for at åbne menuen.</center>",
  ...
  money = {
    ...
    given = "Gav <b style='color: #DB4646'>{1} $</b>.",
    received = "Modtog <b style='color: #4E9350'>{1} $</b>.",
    not_enough = "Ikke nok penge.",
    paid = "Betalte <b style='color: #DB4646'>{1} $</b>.",
    paid2 = "Betalte <b style='color: #DB4646'>{1} $</b>.",
    give = {
      title = "Giv penge",
  ...
  atm = {
    ...
    withdraw = {
      ...
      withdrawn = "<font color=#ddf904>{1}</font> $ hævet.",
  ...
  business = {
    ...
    directory = {
      ...
      dprev = "> Tilbage",
      dnext = "> Næste",
      info = "<em>Kapital: </em>{1} $<br /><em>Ejer: </em>{2} {3}<br /><em>Registrerings#: </em>{4}<br /><em>Telefon: </em>{5}"
    },
    info = {
      title = "Virksomhedsinformationer",
      info = "<em>Navn: </em>{1}<br /><em>Kapital: </em>{2} $<br /><em>Overfør kapital: </em>{3} $<br /><br/>Overfør kapital til næste regnskabsår."
    },
    addcapital = {
      title = "Tilføj kapital",
      description = "Tilføj kapital til din virksomhed.",
      prompt = "Beløb der skal tilføjes:",
      added = "{1} $ blev tilføjet til virksomheskapitalen."
    },
    launder = {
      title = "Hvidvaskning",
      description = "Brug din virksomhed til at vaske penge.",
      prompt = "Beløb der skal vaskes (max {1} $): ",
      laundered = "<font color=#ddf904>{1}</font> $ vasket.",
  ...
  cityhall = {
    ...
    identity = {
      title = "Ny identitet",
      description = "Skift identitet, det koster = {1} $.",
    ...
    menu = {
      title = "Identitet",
      info = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Alder</b>: {3} år<br /><b>CPR</b>: {4}-{11}<br /><b>Mobilnummer</b>: {5}<br /><b>Bankkonto</b>: {10} $<br /><b>Pung</b>: {9} $<br /><b>Kørekort</b>: {8}<br /><b>Adresse</b>: {6} {7}<br /><b>Job</b>: {12}<br /><b>ID</b>: {11}",
      firmainfo = "<b>Fornavn</b>: {2}<br /><b>Efternavn</b>: {1}<br /><b>Fødselsdato</b>: {3}<br /><b>CPR</b>: {4}<br /><b>Pengepung</b>: {8} $<br /><b>Kørekort</b>: {7}<br /><b>Adresse</b>: {5} {6}<br /><b>Firma</b>: {11}<br /><b>Kapital</b>: {12} $<br /><b>ID</b>: {9}"
    }
  },
  police = {
    title = "Politi",
    ...
    menu = {
      ...
      check = {
        ...
        info = "<b>Penge</b>: {1} $<br /><br /><b>Inventar</b>: {2}<br /><br /><b>Våben</b>: {3}",
      ...
      fine = {
        ...
        fined = "Bøde på {2} $ for {1}.",
        notify_fined = "Du fik en bøde på  {2} $ for {1}.",
        record = "[Bøde] {2} $ for {1}"
      },
      store_weapons = {
        title = "Gem våben",
  ...
  gunshop = {
    ...
    info = "<em>Våben: </em> {1} $<br /><em>Ammo: </em> {2} $/u<br /><br />{3}"
  },
  market = {
    title = "{1}",
  ...
  itemtr = {
    informer = {
      ...
      description = "Lokation til sted.{1} $",
